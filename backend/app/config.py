...
WIN_LENGTH = 400
HOP_LENGTH = 160
STREAM_WINDOW_SECONDS = float(os.environ.get("STREAM_WINDOW_SECONDS", str(RECORD_SECONDS)))
STREAM_STEP_SECONDS = float(os.environ.get("STREAM_STEP_SECONDS", "0.5"))
STREAM_VIDEO_SAMPLE_FPS = float(os.environ.get("STREAM_VIDEO_SAMPLE_FPS", "6.0"))
STREAM_MAX_BUFFER_SECONDS = float(os.environ.get("STREAM_MAX_BUFFER_SECONDS", str(max(6.0, RECORD_SECONDS * 2))))
